package com.elcaretes.bootbasic.config;
...
public class DBConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactory(DataSource dataSource) throws IOException {
        ...
        factoryBean.setTypeAliasesPackage("com.elcaretes.bootbasic.model");
		
		// 매퍼 xml의 경로 설정
        factoryBean.setMapperLocations(applicationContext.getResources("classpath:com/elcaretes/bootbasic/sql/*.xml"));
